...
const api: BrowserApi = {
  profiles: {
    ...
    exportBackup: (id: string, password: string) => ipcRenderer.invoke('profiles:export-backup', id, password),
    importBackup: (password: string) => ipcRenderer.invoke('profiles:import-backup', password),
